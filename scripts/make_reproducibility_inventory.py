...
ARTIFACTS = [
    ...
    ("non_overlap_itransformer_sensitivity", "experiments/results/revision/non_overlap_itransformer_sensitivity.csv", "Non-overlap test-window sensitivity for retained iTransformer+ERA5 checkpoints."),
    ...
    ("non_overlap_eval_runs", "experiments/results/tables/non_overlap_eval_runs.csv", "iTransformer+ERA5 non-overlap subset per-run test metrics."),
