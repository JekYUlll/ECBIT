...
\begin{figure*}[t]
  ...
  \caption{ECBIT architecture. Sparse AWS observations and aligned ERA5 sequences are encoded as variate tokens in separate streams. ERA5 information enters through cross-attention, but the variable-level gate suppresses ERA5 influence for variables without missing positions.}
